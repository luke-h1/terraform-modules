...
resource "aws_db_instance" "rds_db" {
  ...
  identifier                      = var.identifier == "" ? "${var.env}-${var.name}" : var.identifier
  username                        = var.user
  ...
  final_snapshot_identifier       = var.final_snapshot_identifier == "" ? "${var.env}-${var.name}-final-snapshot" : var.final_snapshot_identifier
...
resource "aws_iam_role" "rds_monitoring" {
  ...
  name                = "rds-${var.name}-${var.env}-enhanced-monitoring"
...
resource "aws_db_instance" "rds_replica" {
  ...
  identifier             = var.identifier == "" ? "${var.env}-${var.name}-replica" : "${var.identifier}-replica"
